...
import com.kampus.storyscapes.DummyData
import com.kampus.storyscapes.MainDispatcherRule
import com.kampus.storyscapes.adapter.StoryListAdapter
import com.kampus.storyscapes.getOrAwaitValue
...
class MainViewModelTest{
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        Mockito.`when`(storyRepository.getStoryData()).thenReturn(expectedStory)
    ...
    fun `when Get Story Empty Should Return No Data`() = runTest {
        ...
        Mockito.`when`(storyRepository.getStoryData()).thenReturn(expectedQuote)
        val mainViewModel = HomeViewModel(storyRepository)
        val actualStory: PagingData<Story> = mainViewModel.story.getOrAwaitValue()
        val differ = AsyncPagingDataDiffer(
            diffCallback = StoryListAdapter.DIFF_CALLBACK,
